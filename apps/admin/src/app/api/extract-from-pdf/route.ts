...
3. **جدول الإجابات**: ابحث في أسفل الصفحة عن جدول مثل:
   \\`1 | 2 | 3 | ...\\`
   \\`A | C | B | ...\\`
  ...
  "questions": [
    {
      ...
      "choices": [
        { "label": "A", "text": "نص الخيار أ" },
        { "label": "B", "text": "نص الخيار ب" },
        { "label": "C", "text": "نص الخيار ج" },
        { "label": "D", "text": "نص الخيار د" }
      ],
      "correct_answer": "A",
      "year": 2024
    }
