    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header style={{ background: 'linear-gradient(90deg, #0a2d6e, #1a4fa8)' }}
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-bold text-lg">📚 إدارة المواد</h1>
        </div>
        <button onClick={openAdd}
                className="bg-yellow-500 hover:bg-yellow-400 text-white font-bold px-4 py-2 rounded-lg text-sm transition-colors">
          ➕ مادة جديدة
        </button>
      </header>
